...
export const ROV_ROUTES: Routes = [
  ...
  { path: 'rovrptmenu', component: RovReportsMenuComponent },
  { path: 'rovrptsalestran', component: RovSalesTranRptPageComponent },
  { path: 'rovrptsettlement', component: RovSettlementReportPageComponent }
];
