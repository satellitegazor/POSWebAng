...
export class RovLogonDataService {
  ...
  public setLTVendorLogonData(rovVendorLogonData: VendorLoginResultsModel): void {
  ...
  public setLocationConfig(evConfig: EventConfig) {
          ...
          public getLocationConfig(): EventConfig {
              //return this._ltLocationConfig;
              let locConfig: EventConfig = new EventConfig();
              ...
              locConfig.eventID = Number(sessionStorage.getItem('eventID') ? sessionStorage.getItem('eventID') : '0');
              locConfig.eventName = String(sessionStorage.getItem('eventName') ? sessionStorage.getItem('eventName') : '0');
