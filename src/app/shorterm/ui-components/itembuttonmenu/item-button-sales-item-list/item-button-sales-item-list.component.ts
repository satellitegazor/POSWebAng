...
import { SaleItemButton } from '../../../../longterm/models/sale.item.button';
...
export class ItemButtonSalesItemListComponent implements OnInit, OnChanges, CanComponentDeactivate {
  ...
  @Output() itemAdded = new EventEmitter<SaleItemButton>();
  @Output() itemDeleted = new EventEmitter<SaleItemButton>();
  @Output() itemUpdated = new EventEmitter<SaleItemButton>();
