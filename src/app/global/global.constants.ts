...
export enum LTCBusinessFunctionCode {
...
export enum ROVBusinessFunctionCode {
    BUSFNC_LTR_CASH_CARRY = 'BUSFNC_LTR_CASH_CARRY',
    BUSFNC_ST_CASH_CARRY = 'BUSFNC_ST_CASH_CARRY',
    BUSFNC_LTR_PHOTOGRAPHY = 'BUSFNC_LTR_PHOTOGRAPHY',
    BUSFNC_LTR_OTHER_CASH_CARRY = 'BUSFNC_LTR_OTHER_CASH_CARRY',
    BUSFNC_LMTD_TIME_EVNTS = 'BUSFNC_LMTD_TIME_EVNTS',
    BUSFNC_ST_FOOD_AGRMTS = 'BUSFNC_ST_FOOD_AGRMTS',
    BUSFNC_LTR_FOOD = 'BUSFNC_LTR_FOOD'
}